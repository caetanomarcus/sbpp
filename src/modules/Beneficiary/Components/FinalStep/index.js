	...
	return (
		<S.Wrapper>
			...
			<S.Container >
				...
				<>
						<S.Row >
					<S.Title>Adicionar dados de Pensão Judicial?</S.Title>
					<S.Checkbox type='checkbox' checked={courtPensionData.hasCourtPension} readOnly />
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Matricula Previdenciária</S.Title>
						<S.Value>{courtPensionData.previdencyRegistration}</S.Value>
					</S.TextBox>
					<S.TextBox marginLeft='24px'>
						<S.Title>Matricula do Pensionista</S.Title>
						<S.Value>{courtPensionData.pensionistRegistration}</S.Value>
					</S.TextBox>
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Nome do Pensionista</S.Title>
						<S.Value>{courtPensionData.pensionistName}</S.Value>
					</S.TextBox>
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Tipo de Pensão</S.Title>
						<S.Value>{courtPensionData.pensionType}</S.Value>
					</S.TextBox>
					<S.TextBox marginLeft='76px'>
						<S.Title>Tipo de Renda</S.Title>
						<S.Value>{courtPensionData.incomeType}</S.Value>
					</S.TextBox>
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Modalidade</S.Title>
						<S.Value>{courtPensionData.modality}</S.Value>
					</S.TextBox>
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Ofício Judicial</S.Title>
						<S.Value>{courtPensionData.judicialOffice}</S.Value>
					</S.TextBox>
					<S.TextBox marginLeft='100px'>
						<S.Title>Fatores de Desconto (%)</S.Title>
						<S.Value>{courtPensionData.discountFactor}</S.Value>
					</S.TextBox>
				</S.Row>
				<S.Row>
					<S.TextBox>
						<S.Title>Início</S.Title>
						<S.Value>{courtPensionData.pensionStart}</S.Value>
					</S.TextBox>
					<S.TextBox marginLeft='76px'>
						<S.Title>Fim</S.Title>
						<S.Value>{courtPensionData.pensionEnd}</S.Value>
					</S.TextBox>
				</S.Row>
				</>
				)}
